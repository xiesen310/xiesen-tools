 ...
 * 
 * 在创建了Mail对象之后 可以调用它的setSubject()、setContent()，设置主题和正文 也可以调用setFrom()和
 * addToAddress()，设置发件人，和添加收件人。 也可以调用addAttch()添加附件 创建AttachBean：new
 * AttachBean(new File("..."), "fileName");
 */
public class Mail {
